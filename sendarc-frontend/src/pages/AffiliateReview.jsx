        ...
        <div className="max-w-5xl mx-auto px-6 py-14">
          ...
          <Reveal delay={100}>
            <Card className="overflow-hidden mb-8">
              <div className="grid grid-cols-3 px-5 py-3 border-b border-[#1e2530] text-[10px] tracking-widest text-[#4a5568]">
                <span></span>
                <span className="text-center">STANDARD</span>
                <span className="text-center text-[#00D4FF]">AFFILIATE</span>
              </div>
              {[
                { label: 'Per referral', standard: '50 $PARA', affiliate: '80 $PARA' },
                ...
                <div key={row.label} className="grid grid-cols-3 px-5 py-3.5 border-b border-[#1e2530] last:border-0 text-sm">
                  ...
                  <span className="text-center text-[#8892a0]">{row.standard}</span>
                  <span className="text-center text-white font-semibold">{row.affiliate}</span>
                </div>
              ))}
            </Card>
          </Reveal>
